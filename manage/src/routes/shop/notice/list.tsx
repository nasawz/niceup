          ...
          <Switch
            ...
            onChange={() => {
              update(rec._id, { state: state == 0 ? 1 : 0 }, err => {
                if (!err) {
                  // mutate();
                  showToast(`${rec.page}公告${state == 0 ? '展示' : '隐藏'}`);
                }
              });
            }}
          ></Switch>
      ...
      return (
        ...
        >
          <FormRow
            name="message"
            label="消息内容"
            messageVariables={{ displayName: '消息内容' }}
            rules={[{ required: true }]}
          >
            <EuiFieldText />
          </FormRow>
          <FormRow
            name="color"
            label="文字颜色"
            messageVariables={{ displayName: '文字颜色' }}
            rules={[{ required: true }]}
          >
          ...
          <FormRow
            name="background"
            label="背景颜色"
            messageVariables={{ displayName: '背景颜色' }}
            rules={[{ required: true }]}
          >
          ...
          <FormRow
            name="icon"
            label="图标"
            messageVariables={{ displayName: '图标' }}
            rules={[{ required: true }]}
          >
            <SuperSelect
              options={[
          ...
          <FormRow
            name="page"
            label="页面"
            messageVariables={{ displayName: '页面' }}
            rules={[{ required: true }]}
          >
            <SuperSelect
              options={[
                {
                  value: 'confirm',
                  inputDisplay: '提交订单页',
                  dropdownDisplay: <React.Fragment>提交订单页</React.Fragment>,
                },
                {
                  value: 'detail',
                  inputDisplay: '商品详情页',
                  dropdownDisplay: <React.Fragment>商品详情页</React.Fragment>,
                },
                {
                  value: 'bag',
                  inputDisplay: '购物车',
                  dropdownDisplay: <React.Fragment>购物车</React.Fragment>,
                },
              ]}
            />
          </FormRow>
          <EuiFlexItem>
            <FormRow
              name="needFeedback"
              label="反馈"
              messageVariables={{ displayName: '反馈' }}
              rules={[{ required: true }]}
            >
              <Switch label="开启" />
            </FormRow>
